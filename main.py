...
import os
from milvus_data import find_most_similar_sentence, parse_medical_history,store_medical_data_in_graph_db
...
async def diagnose(request: DiagnosisRequest):
    ...
    # structured_json_extracted_user_information = parse_medical_history(patient_history)
    # store_medical_data_in_graph_db(structured_json_extracted_user_information)
    report_data += "  patient medical and genetic history :- " + patient_history 
